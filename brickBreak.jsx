...
export default class App extends Component {
    ...
    getShapeSize = (shape) => {
        ...
        if (shape.charAt(0) === 'L' || shape.charAt(0) === 'T' || shape.charAt(0) === 's') {
            shapeSize = 4;
        }
        
        else if (shape.charAt(0) === 'v' || shape.charAt(0) === 'h') {
            shapeSize = 3;
        }
    ...
    handleGridSquarePress = (row, col) => {
        ...
        if (this.canPlaceShape(this.state.shape, row, col)) {
            ...
            // Update score
            this.updateScore(this.getShapeSize(this.state.shape));
        ...
        // Find the right place for this block of code and we're done (this is handlePress function but it needs to go somewhre else)
        else {
    ...
    handleInstructionsScreenPress = () => this.setState(state=> ({
        titleScreen: 'none',
        gameScreen: 'none',
        gameOverScreen: 'none',
        highScoresScreen: 'none',
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <View style={{display: this.state.titleScreen}}>
                    <View style={styles.content}>
                        ...
                        <TouchableHighlight style={styles.startButton}
                            onPress={this.handleInstructionsScreenPress}
                        >
                ...
                {/* Instructions Screen */}
                <View style={{display: this.state.instructionsScreen}}>
                    <View style={styles.content}>
                        ...
                        <Text style={styles.text}>
                            Click the square on the grid where you want the white
                            square of the shape to place. 
                            Gain points by dropping shapes, but mainly by completely
                            filling a row and/or column! The game ends when you
                            have no place left to put the generated shape.
                        </Text>
